  ...
  return (
    <section id="process" className="py-16 md:py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Bottom CTA */}
        <div className="mt-12 md:mt-20 text-center bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative">
            <h3 className="text-2xl md:text-3xl font-black text-white mb-3">Ready to Start Your First Export Order?</h3>
